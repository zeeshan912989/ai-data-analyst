    ...
    <main className="min-h-screen grid lg:grid-cols-2 bg-slate-50">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 relative h-full">
        ...
        <div className="w-full max-w-[440px] space-y-8 bg-white p-8 sm:p-10 rounded-[2rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-slate-100 mt-12 lg:mt-0">
          ...
          {/* Social Logins */}
          <div className="flex gap-4 relative z-[9999] w-full">
            <button 
              type="button"
              onClick={async (e) => {
                e.preventDefault();
                ...
                try {
                  ...
                  if (error) alert("Google Signup error: " + error.message);
                } catch (e: any) {
                  alert("Exception: " + e.message);
                }
              }}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors shadow-sm text-slate-700 font-bold text-sm cursor-pointer hover:shadow-md"
            >
            ...
            <button 
              ...
              onClick={async (e) => {
                ...
                try {
                  ...
                  if (error) alert("GitHub Signup error: " + error.message);
                } catch (e: any) {
                  alert("Exception: " + e.message);
                }
              }}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors shadow-sm text-slate-700 font-bold text-sm cursor-pointer hover:shadow-md"
            >
              <svg className="w-5 h-5 text-slate-900 pointer-events-none" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
