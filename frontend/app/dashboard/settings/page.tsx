  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 font-medium mt-2 max-w-2xl">Manage your profile information, workspace configurations, and security preferences including 2FA.</p>
      </div>
