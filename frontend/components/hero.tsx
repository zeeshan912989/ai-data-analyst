          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-16">
              {(() => {
                ...
                if (!hasMounted) {
                  return (
                    <Link href="/signup" className="w-full sm:w-auto px-8 py-4 rounded-full bg-blue-600 text-white text-lg font-black hover:bg-blue-700 hover:scale-[1.02] transition-all flex items-center justify-center gap-2">
